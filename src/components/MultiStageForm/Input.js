...
const Input = ({ field_id, field_label, field_placeholder, field_value,field_type,field_disable }) => {
    ...
    return (
        ...
        <input type={field_type} style={field_disable ? {backgroundColor : "lightgrey" ,fontSize:"10px" } : {}} className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"
